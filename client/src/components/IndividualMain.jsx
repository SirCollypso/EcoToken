...
const IndividualMain = () => {
  const { currentAccount, connectWallet, clientBalance, businessStatus, participatedEvents, transferEcotokens, voteForEvent, isLoading, handleIndividualChange, individualFormData } = useContext(EcoTokenContext);
    ...
    <div className="flex flex-col w-full justify-center items-center">
      <div className="flex mf:flex-row flex-col items-center justify-between">
        ...
        { !currentAccount && (
          ...
          <h1 className="text-center sm:text-5xl text-white text-gradient py-1">Our company slogan</h1>
        ...
        { (currentAccount && businessStatus) && (
          <div className="flex flex-1 justify-center items-center flex-col mf:mr-10 md:p-20 py-12 px-4">       
            <h1 className="text-center sm:text-5xl text-white text-gradient py-1">You are registered as Business</h1>
            <p className="text-center mt-5 text-white font-light md:w-9/12 w-11/12 text-base">Description.</p>  
          </div>
        ) }
